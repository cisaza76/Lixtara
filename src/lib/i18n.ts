...
const dictionaries = {
  en: {
    ...
    listingForm: {
      ...
      step5: {
        title: "Add photos.",
        body: "Upload at least 10 high-quality photos. Drag files into the picker or click to select. JPG, PNG, or WebP, max 10MB each.",
  ...
  es: {
    ...
    listingForm: {
      ...
      step5: {
        title: "Agrega fotos.",
        body: "Sube al menos 10 fotos de buena calidad. Arrastra los archivos al selector o haz click para seleccionar. JPG, PNG o WebP, máximo 10MB cada uno.",
